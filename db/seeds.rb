...
User.destroy_all
 ...
 Art.create!(title: "Le Penseur", category: "Sculpture", creation_date: Date.new(1902, 1, 1), price: 150_000, name: "Auguste Rodin", user: user1)
 Art.create!(title: "Les Nymphéas", category: "Peinture", creation_date: Date.new(1920, 1, 1), price: 400_000, name: "Claude Monet", user: user1)
 Art.create!(title: "La Persistance de la mémoire", category: "Peinture", creation_date: Date.new(1931, 1, 1), price: 350_000, name: "Salvador Dalí", user: user1)
 ...
 Art.create!(title: "Guernica", category: "Peinture", creation_date: Date.new(1937, 1, 1), price: 450_000, name: "Pablo Picasso", user: user2)
 Art.create!(title: "Le Cri", category: "Peinture", creation_date: Date.new(1893, 1, 1), price: 280_000, name: "Edvard Munch", user: user2)
 Art.create!(title: "Les Demoiselles d'Avignon", category: "Peinture", creation_date: Date.new(1907, 1, 1), price: 500_000, name: "Pablo Picasso", user: user2)
